...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyworms-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11993&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyworms-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyworms` can be installed with:

```
conda install pyworms
```

It is possible to list all of the versions of `pyworms` available on your platform with:
